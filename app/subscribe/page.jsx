...
const PLANS = [
  {
    ...
    tag: "Most Popular",
    tagColor: "#7B8FAE",
    description: "$11.99 in band credit each month — send a band the moment someone needs prayer, personalized right then.",
    perks: ["$11.99 band credit / month", "Save 20% — pay $9.59", "Free shipping every send", "Never expires · cancel anytime"],
  },
  {
    id: "quarterly",
    ...
    tag: "Seasonal",
    tagColor: "#7BAE8E",
    description: "$11.99 in band credit every quarter — a seasonal rhythm of giving, sent whenever the moment comes.",
    perks: ["$11.99 band credit / quarter", "Save 15% — pay $10.19", "Free shipping every send", "Never expires · cancel anytime"],
  },
  {
    id: "bundle",
    name: "Bundle Sender",
    ...
    tag: "Most Impact",
    tagColor: "#C8A96E",
    description: "Two bands' worth of credit ($23.98) every month — for those called to spread prayer widely.",
    perks: ["$23.98 band credit / month", "Save 25% — pay $17.99", "Free shipping every send", "Never expires · cancel anytime"],
  },
];
