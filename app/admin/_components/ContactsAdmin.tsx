...
export default function AdminContactsPage({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <div className={embedded ? "admin-contacts admin-contacts--embedded" : "admin-contacts"}>
      {!embedded && (
...
const adminStyles = `
  ...
  .admin-contacts--embedded { min-height: 0; background: transparent; padding: 0; }
