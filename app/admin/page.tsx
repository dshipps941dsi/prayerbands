      ...
      <div className="pb-admin-content" style={{ padding: '24px 32px' }}>
        ...
        {activeTab === 'orders' && (
          <div>
            ...
            {/* Pre-dedicate moved to Activity → Dedications, where it sits with
                the list of dedications it writes to. */}
                          ...
                          {!isShipped && bands.length < qty && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', width: '100%' }}>
                              <div style={{ fontSize: '12px', color: C.secondary }}>
                                {bands.length} of {qty} band{qty > 1 ? 's' : ''} assigned — tap bands into this order in the Packing Station:
                              </div>
                              <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
                                <a
                                  href="/fulfill"
                                  style={{ padding: '8px 16px', background: C.navy, color: '#F5EDD8', borderRadius: '6px', textDecoration: 'none', fontSize: '11px', fontFamily: 'Cinzel, serif', textTransform: 'uppercase' as const, letterSpacing: '0.05em', fontWeight: '600' }}
                                >
                                ...
                                <button
                                  ...
                                  title="Auto-pick matching bands from stock (fallback — the Packing Station is the main flow)"
                                ...
                                >
                                  {assigningBands === order.id ? 'Auto…' : 'Auto-fill from stock'}
                                </button>
                              </div>
                            </div>
                          )}
