...
export default function BandJourney() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      // Load org if band belongs to one
      if (band.org_id) {
    ...
    <div style={{minHeight:'100vh',background:'linear-gradient(160deg,#e8f4fd,#fdf6e3,#dcf2e6)',fontFamily:'sans-serif'}}>
      ...
      {org && (
        <div style={{
          ...
          <span style={{opacity: 0.9}}>This band was given to you by </span>
          
            href={`https://${org.subdomain}.prayerbands.com`}
            target="_blank"
      ...
      <div style={{maxWidth:'720px',margin:'0 auto',padding:'40px 24px 80px'}}>
        ...
        <div style={{position:'relative',paddingLeft:'36px'}}>
          ...
          {registrations.length === 0 && (
            <div style={{background:'#fff',borderRadius:'14px',padding:'32px',textAlign:'center',border:'1.5px solid #e2eaf4'}}>
              ...
              {org && (
                <p style={{fontSize:'14px',color:'#5a4f42',marginBottom:'8px',fontStyle:'italic'}}>
                  {org.name} gave you this band as a prayer. ✝
                </p>
              )}
        ...
        {org && (
          <div style={{
            ...
            <div>
              <div style={{fontSize: 12, color: '#8a7c6a', marginBottom: 4, fontFamily: 'Georgia, serif'}}>
                This band was distributed by
              </div>
              <div style={{fontSize: 16, fontWeight: 'bold', color: '#1a1208', fontFamily: 'Georgia, serif'}}>
                {org.name}
              </div>
              {org.location && (
                <div style={{fontSize: 13, color: '#8a7c6a'}}>{org.location}</div>
              )}
            </div>
