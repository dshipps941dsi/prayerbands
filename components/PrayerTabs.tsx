...
const INFO: Record<Sub, { title: string; body: string }> = {
  ...
  partners: {
    ...
    body: 'Partners are the people you’re connected to in prayer. To add one in person, use “Connect a prayer partner” below — read them the code from the top of your band’s page (or show your QR), or enter theirs. “Direct” partners are people you connected with directly; “Lineage” partners are those a band actually passed between. You can sort partners into private groups — Youth Group, Baseball Team — that only you can see, then share a prayer to just that group. “Their Requests” gathers prayers your partners and circles have shared: tap 🙏 to pray, or Mute anyone whose requests you’d rather not see (they’re never told).',
  },
  circles: {
