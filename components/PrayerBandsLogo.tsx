// components/PrayerBandsLogo.tsx
// Usage: <PrayerBandsLogo size={40} color="#B8860B" />
...
const PrayerBandsLogo: React.FC<LogoProps> = ({
  size = 40,
  color = 'currentColor',
  className = '',
  style,
  ...
  <svg
    ...
    viewBox="0 0 209.55 242.82"
    width={size}
    height={size}
    fill={color}
    className={className}
    style={style}
    aria-label="Prayer Bands logo"
  >
...
export default PrayerBandsLogo;